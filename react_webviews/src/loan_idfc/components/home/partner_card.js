    ...
    return (
      <Card className="partner-card">
        ...
        >
          ...
          <Button variant="raised" size="large" autoFocus>
            {this.props.otp_verified ? "RESUME" : "APPLY NOW"}
          </Button>
        </div>
        {this.props.baseData.benefits && (
          <div className="benefits" onClick={() => this.props.handleBenefits()}>
            <div className="benefits-header">
              Benefits
              <SVG
                preProcessor={(code) =>
                  code.replace(/fill=".*?"/g, "fill=" + getConfig().styles.primaryColor)
                }
                src={require(`assets/${
