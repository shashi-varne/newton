    ...
    return (
        <div className="loan-agreement" style={{fontSize:'13px', color:'#767e86'}}>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">1.</div>
                <div className="agree-tiles-right">DEFINITIONS</div>
            </div>
            ...
            <div>
                {terms.map((term, index) => <p key={index}>{term}</p>)}
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">1.</div>
                <div className="agree-tiles-right">DISBURSEMENT</div>
            </div>

            <div>{disbursement.map((item, index) => renderAgreement(item, '1.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">2.</div>
                <div className="agree-tiles-right">INTEREST AND REPAYMENT</div>
            </div>

            <div>{interest_and_repayment.map((item, index) => renderAgreement(item, '2.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">3.</div>
            ...
            <div className="agree-tiles">
                ...
                <div className="agree-tiles-right">BORROWER’S COVENANTS, REPRESENTATION AND WARRANTIES</div>
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">5.</div>
                <div className="agree-tiles-right">EVENTS OF DEFAULT</div>
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">6.</div>
                <div className="agree-tiles-right">CONSEQUENCES OF DEFAULT</div>
            </div>

            <div>{consequences.map((item, index) => renderAgreement(item, '6.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">7.</div>
                <div className="agree-tiles-right">DISCLOSURES</div>
            </div>

            <div>{disclosures.map((item, index) => renderAgreement(item, '7.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">8.</div>
                <div className="agree-tiles-right">MISCELLANEOUS</div>
            </div>

            <div>{miscellaneous.map((item, index) => renderAgreement(item, '8.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">9.</div>
                <div className="agree-tiles-right">SEVERABILITY</div>
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">10.</div>
                <div className="agree-tiles-right">GOVERNING LAW AND JURISDICTION</div>
            </div>

            <div>{law.map((item, index) => renderAgreement(item, '10.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">11.</div>
                <div className="agree-tiles-right">NOTICES</div>
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">12.</div>
                <div className="agree-tiles-right">ASSIGNMENT</div>
            </div>

            <div>{assignment.map((item, index) => renderAgreement(item, '12.'+(index+1)))}</div>

            <div className="agree-tiles">
                <div className="agree-tiles-left">13.</div>
                <div className="agree-tiles-right">INDEMNITY</div>
            </div>
            ...
            <div className="agree-tiles">
                <div className="agree-tiles-left">14.</div>
                <div className="agree-tiles-right">Acceptance:</div>
            </div>
