    ...
    >
        ...
        <ul>
          ...
          <li>
            ...
            <div className="text">
              ...
              <p>
                Withdraw amount after 60 years age and enjoy your retirement to
                the fullest.
              </p>
            </div>
          </li>
      ...
      <div className="nps-know-more">
        <div className="detail">
          ...
          <p>
            ...
            up to 10 % of gross income under Sec 80 CCD (1) with in the overall
            ceiling of Rs. 1.5 lakhs under Sec 80 CCE.
          </p>
          <p>
          ...
          <p ng-if="!finity">
            c) Tax benefits are applicable for investments in Tier I account
            only & hence, fisdom doesn't offer investments in Tier II at this
            time.
          </p>
          <p ng-if="finity">
            c) Tax benefits are applicable for investments in Tier I account
            only & hence, finity doesn't offer investments in Tier II at this
            time.
          </p>
        </div>
      </div>
      ...
      <div className="nps-know-more">
        <div className="detail">
          ...
          <p>
            As per Pension Fund Regulatory & Development Authority (PFRDA) Exit
            Rules, following Withdrawal categories are allowed:
          </p>
          <p>
            <b>a) Upon normal superannuation - </b> At least 40% of the
            accumulated pension wealth of the subscriber has to be utilized for
            purchase of annuity providing for monthly pension of the subscriber
            and the balance is paid as lump sum to the subscriber.
          </p>
          <p>
            In case the total corpus in the account is less than Rs. 2 Lakhs as
            on the Date of attaining the age of 60, the subscriber can avail the
            option of complete Withdrawal.
          </p>
          <p>
            <b>b) Upon death - </b> The entire accumulated pension wealth (100%)
            would be paid to the nominee/legal heir of the subscriber and there
            would not be any purchase of annuity/monthly pension.
          </p>

          <p>
            <b>c) Exit from NPS Before the age of normal superannuation - </b>{" "}
            At least 80% of the accumulated pension wealth of the subscriber
            should be utilized for purchase of an annuity providing the monthly
            pension of the subscriber and the balance is paid as a lump sum to
            the subscriber.
          </p>
