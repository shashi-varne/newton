...
export const FUNDOPTION = 'diystore_fundOption'
export const SORTFILTER = 'diystore_sortFilter'
export const CATEGORY = 'diystore_category'

export const CART_LIMIT = 24