    ...
    render() {
        ...
        return (
            <Container
                ...
                title={this.state.member_key === 'self' ? 'Your pre-existing diseases' : this.setEditTitle(capitalizeFirstLetter(childeNameMapper(this.state.member_key)) + "'s pre-existing diseases")}
