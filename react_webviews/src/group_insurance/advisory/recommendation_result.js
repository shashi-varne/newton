          ...
          >
            <DialogContent>
                <div className="more-details-container">
                    ...
                    <div className={recommendation_data.key === 'term' && !adequate_coverage_present ?  "coverage-details" : "coverage-details align-left" }>
                        ...
                        { recommendation_data.key === 'term' && !adequate_coverage_present ? (
                        <div className="individual-coverage-detail">
                    ...
                    <div style={{margin: '0 5px', marginTop: '20px', width: '100%'}}>
                        <button  className="call-back-popup-button" style={{opacity : (key === 'corona' || key === 'term') && !adequate_coverage_present ? '0.4' : '1'}} onClick={()=>this.getPlan(recommendation_data.key, 'plan details bottom sheet', adequate_coverage_present )}>{this.state.more_details_cta_text}</button> 
                    </div>
                </div>
            ...
            <div className="recommendation-result">
                ...
                {!adequate_coverage_present  ? (
                    ...
                    <div className="recommendation-cta-container">
                        ...
                        <div className="get-the-plan" style={{opacity: (recommendation_data.key === 'corona' || recommendation_data.key === 'term') ? '0.4': '1'}} onClick={()=>this.getPlan(recommendation_data.key, 'recommendations', adequate_coverage_present)}>GET THE PLAN</div>
                    </div>
                    </div>
                ):(
