    ...
    >
      <DialogContent className="kyc-back-confirm-dialog-content">
        ...
        <div className="confirm-back-dialog-actions">
          <Button classes={{ button: "confirm-back-button confirm-back-yes" }} onClick={goBack} buttonTitle="YES" />
          <Button classes={{ button: "confirm-back-button" }} onClick={close} buttonTitle="NO" />
        </div>
      </DialogContent>
    </Dialog>
  );
