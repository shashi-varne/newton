if (environment && environment == "sdk") {
    ("use strict");
      ...
      .run([
        ...
        function (
          ...
          $rootScope.$on("$stateChangeStart", function (
            ...
            // Stop redirection if unauthenticated
            if (fromState.name !== '' && toState.name === 'prepare') {
              callbackWeb.user_exit();
            }
  
            if (storageService.get('native') && (toState.name === 'landing' || toState.name === 'invest')) {
              callbackWeb.user_exit();
            }
          });
          ...
          $rootScope.$on("$stateChangeSuccess", function (
            ...
            if ($rootScope.toState === "landing" || appService.isNpsOutsideSdk($rootScope.partner,
              ...
              callbackWeb.take_back_button_control();
              callbackWeb.clear_history();
            } else {
              callbackWeb.reset_back_button_control();
            }
          });
