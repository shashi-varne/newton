...
class ComponentsBase extends Component {
  ...
  render() {
    ...
    return (
     ...
     {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
  ...
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>BottomInfo</h3>
            <BottomInfo baseData={{ 'content': 'Your information is safe and secure with us' }} /> </div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>BottomSheet</h3>
            <BottomSheet data={'hello world'} /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>CustomButton 1:</h3>
            <CustomButton twoButton={true} buttonOneTitle={'Download'} buttonTwoTitle={'Continue'} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>CustomButton 2:</h3>
            <CustomButton twoButton={true} dualbuttonwithouticon={true} buttonOneTitle={'Download'} buttonTwoTitle={'Continue'} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>CustomButton 3:</h3>
            <div style={{ backgroundColor: 'rgb(53, 203, 93)', color: 'white', width: '130px', borderRadius: '6px' }}>
              <CustomButton twoButton={false} dualbuttonwithouticon={true} buttonTitle={'Continue'} /></div></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            ...
            <ReactResponsiveCarousel
              ...
              callbackFromParent={() => console.log("fisdom")} /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>CheckBox</h3>
            <CheckBox handleChange={this.handleChange("check")} checked={this.state.check} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>CheckboxList</h3></div>
  ...
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            ...
            <DropdownInModal
              ...
              id="height"
              name="height"
              onChange={this.handleChange('height')} /> </div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            ...
            <DropdownInPage
              ...
              onChange={this.handleChange('setValue')} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>Faqs</h3>
            <Faqs options={[{ 'title': 'fisdom', 'subtitle': 'Insurance', 'points': ['gold', 'insurance', 'equity', 'index funds', 'mutual funds'] }]} /> </div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>GenericTooltip</h3>
            <GenericTooltip productName={'fisdom'} content='fisdom for financial freedom' /> </div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>HowToSteps</h3>
            <HowToSteps
              ...
              showSkelton={true} /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>Icon</h3>
            <Icon src={icn} width='20px' /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>Imgc</h3>
            {/* <Imgc /> */}</div>
  ...
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            ...
            <LandingSteps
              ...
              classNameIcon="steps-icon" /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>LeftRightFooter</h3>
            <LeftRightFooter parent={this} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>Lite-Tooltip</h3>
            <Tooltip
            ...
            <br></br>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            {/* <div className='border-seperation'>  //todo
            <h3>MmYyInModal</h3>
            <div style={{ border: '2px solid red', height: '100px' }}>
              ...
              <MmYyInModal
                ...
                dob={'05/1950'}
                start_date={'05/1990'}
                value={this.state.openPopUpInputDate} />  </div> </div> */}
  ...
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>OtpDefault</h3>
            <OtpDefault parent={this} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>PlusMinusInput</h3>
            <PlusMinusInput name={'fisdom'} label={'insurance'} parent={this} /></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>RadioBtn</h3></div>
            {/* <RadioBtn   /> */}
  ...
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
   ...
   {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            ...
            <StepsToFollow title='fisdom' subtitle='equity' keyId='3' /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>TitleWithIcon</h3>
            <TitleWithIcon icon={icn} width={'50px'} title={'fisdom'} /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>TermsAndConditions</h3>
            <TermsAndConditions parent={this} /></div>

  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
            <div className='border-seperation'>
            <h3>toast('Something went wrong')</h3>
            <button onClick={() => { toast('Something went wrong') }}>Click Me</button></div>
  {/* ------------------------------------------------------------------------------------------------------------------------------------------------------*/}
          </div>
        </div>
      </div>
