    ...
    >
      ...
      <div className="kfadc-header" data-aid='kfadc-header'>Select option</div>
        <div className="kfadc-main" data-aid='kfadc-main'>
          <div className="kfadc-info" data-aid='kfadc-info-gallery' onClick={() => handleUpload("gallery")}>
            <img src={require(`assets/go_to_gallery_green.svg`)} alt="" />
            <div>Gallery</div>
          </div>
          <div className="kfadc-info" data-aid='kfadc-info-camera' onClick={() => handleUpload("camera")}>
