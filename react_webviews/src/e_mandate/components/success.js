  ...
  render() {
    ...
    return (
      <Container
        ...
        title="easySIP authorisation successful!"
        ...
        iframeRightContent={this.state.sip_resumed}
      >
        <div>
          {(!this.state.iframe || this.state.isMobileDevice) &&  <div className="success-img">
            <Imgc alt="Mandate" src={this.state.sip_resumed}
            style={{minHeight:130, width:"100%"}} />
          </div> }
          <div className={this.state.iframe && !this.state.isMobileDevice && 'iframe-e-mandate-success'}>
