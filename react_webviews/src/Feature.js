...
const Insurance = lazy(() =>
  import(/*webpackChunkName: "Insurance"*/ "./insurance")
);
const GroupInsurance = lazy(() =>
  import(/*webpackChunkName: "GroupInsurance"*/ "./group_insurance")
);
const Referral = lazy(() =>
  import(/*webpackChunkName: "Referral"*/ "./referral")
);
const Gold = lazy(() => import(/*webpackChunkName: "Gold"*/ "./gold"));
const Mandate = lazy(() =>
  import(/*webpackChunkName: "Mandate"*/ "./mandate_address")
);
const Mandate_OTM = lazy(() =>
  import(/*webpackChunkName: "Mandate_OTM"*/ "./mandate_otm")
);
const EMandate = lazy(() =>
  import(/*webpackChunkName: "EMandate"*/ "./e_mandate")
);
const RiskProfiler = lazy(() =>
  import(/*webpackChunkName: "RiskProfiler"*/ "./risk_profiler")
);
const HNI = lazy(() =>
  import(/*webpackChunkName: "HNI"*/ "./external_portfolio")
);
const IsipBIller = lazy(() =>
  import(/*webpackChunkName: "IsipBiller"*/ "./isip")
);
const HelpSupport = lazy(() =>
  import(/*webpackChunkName: "HelpSupport"*/ "./help_support_v2")
);
const CommonLanding = lazy(() =>
  import(/*webpackChunkName: "CommonLanding"*/ "./common/components/landing")
);
const Withdraw = lazy(() =>
  import(/*webpackChunkName: "Withdraw"*/ "./withdraw")
);
const Report = lazy(() => import(/*webpackChunkName: "Report"*/ "./reports"));
const Fhc = lazy(() => import(/*webpackChunkName: "Fhc"*/ "./fhc"));
// const Loan = lazy(() => import(
//   /*webpackChunkName: "Loan"*/ './loan_idfc'
// ));
const Payment = lazy(() => import(/*webpackChunkName: "Payment"*/ "./payment"));
const KycEsign = lazy(() =>
  import(/*webpackChunkName: "KycEsign"*/ "./kyc_esign")
);
const PortfolioRebalancing = lazy(() =>
  import(/*webpackChunkName: "PortfolioRebalancing"*/ "./portfolio_rebalancing")
);
const FundDetails = lazy(() =>
  import(/*webpackChunkName: "FundDetails"*/ "./fund_details")
);
const Whatsapp = lazy(() =>
  import(/*webpackChunkName: "Whatsapp"*/ "./whatsapp")
);
const Landing = lazy(() =>
  import(/*webpackChunkName: "Landing"*/ "./dashboard")
);
const FeedBack = lazy(() =>
  import(/*webpackChunkName: "FeedBack"*/ "./feedback")
);
const Partner = lazy(() => import(/*webpackChunkName: "Partner"*/ "./partner"));
const TaxFiling = lazy(() =>
  import(/*webpackChunkName: "TaxFiling"*/ "./tax_filing")
);
const Kyc = lazy(() => import(/*webpackChunkName: "Kyc"*/ "./kyc"));
const AccountStatements = lazy(() =>
  import(/*webpackChunkName: "AccountStatements"*/ "./account_statements")
);
const EquityPayment = lazy(() =>
  import(/*webpackChunkName: "EquityPayment"*/ "./equity_payment")
);
const FreedomPlan = lazy(() =>
  import(/*webpackChunkName: "FreedomPlan"*/ "./freedom_plan")
);
      ...
      <ErrorBoundary>
        <Suspense fallback={<BootSkeleton />}>
          <Switch>
            ...
            <ProtectedRoute
              path="/webview/:main_module/:sub_module"
              component={CommonLanding}
            />
            <ProtectedRoute
              path="/webview/:main_module"
              component={CommonLanding}
            />
            <ProtectedRoute
