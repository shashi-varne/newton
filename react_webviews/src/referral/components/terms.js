      ...
      <Container
        ...
        <div className="Terms pad25">
          <div className="List">
            ...
            <div className="Text">
              The recommended amount per each referral is a special offer for you and may not applicable for other investors. Fisdom decides and has the right to allocate or terminate any special offer.
            </div>
          </div>
          <div className="List">
